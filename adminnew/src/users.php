                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="scroll-horizontal-datatable"
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM  `admin_users` WHERE user_type!='VENDOR'"; // 
                                                ...
                                                while ($fetch = $query->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-transform: capitalize; !important;">
                                                            <?php echo strtolower($fetch['user_type'])=="admin" ? "Administrator" : strtolower($fetch['user_type']); ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td  style="white-space: nowrap;">
                                                            <a href="adduser?id=<?php echo $fetch['ID'] ?>" class="btn btn-sm btn-outline-primary rounded-pill">Edit</a>
                                                            <!-- <a href="?id=<?php echo $fetch['ID'] ?>" class="btn btn-sm btn-outline-danger rounded-pill" onclick="return confirm('Are you sure to delete thid vendor')">Delete</a> -->
                                                        </td>
                                                    </tr>
                                            <?php } ?>
                                        </tbody>
