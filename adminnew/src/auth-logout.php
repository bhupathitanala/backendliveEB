<?php include 'partials/main.php'; session_destroy(); ?>
...
<body class="authentication-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p class="text-dark-emphasis">Back To <a href="auth-login"
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="text-dark-emphasis">
            <script>document.write(new Date().getFullYear())</script> © EarthBased - Developed by Techvol
        </span>
    </footer>
