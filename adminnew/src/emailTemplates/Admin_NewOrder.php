...
<?php
    ...
    $discount_total = $data['discount_total']; // Total discount
        ...
        <p>Dear Admin,</p>
            ...
            <table class="order-details">
                ...
                <?php
                    ...
                    $sql = "SELECT `product_title`,`product_qty`,`product_price`,`invoice_number`,`payment_type`,`shipping_charges`,`cod_charges`,`amount`,`coupon_code`,`coupon_discount`,`customer_address` FROM `order_details` WHERE order_id='$order_id'";
                    //echo $sql;
                    ...
                    <tr>
                        ...
                        <td style="text-align:right">- ₹ <?php echo $discount_total; ?></td>                                                    
                    </tr>
                    <tr>
