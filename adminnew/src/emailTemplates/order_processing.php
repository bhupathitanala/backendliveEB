        ...
        <div class="content">
            ...
            <table class="order-details">
                ...
                <?php
                    ...
                    $sql = "SELECT a.product_title,a.product_qty,a.product_price,a.order_id,a.payment_type,a.amount,a.coupon_code,a.coupon_discount,a.customer_address,b.tax_status,b.tax,a.shipping_charges,a.cod_charges,c.state FROM order_details a join productsnew b on a.product_id = b.ID join vendors c on c.vendorID=b.vendor_id where a.order_id='$order_id' AND a.invoice_number='$invoice_number'";
