...
<head>
    ...
    <title>Order Shipped - <?php echo $orderId; ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Order Shipped - <?php echo $orderId; ?></h2>
            <p>Dear Admin,</p>
            <p>Good news! Your order has been shipped. Here are the details of your shipment:</p>
            <h3>Order Details:</h3>
