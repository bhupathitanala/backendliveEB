...
<head>
    ...
    <title>Your Order Is on Its Way - <?php echo $orderId; ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Your Order Is on Its Way - <?php echo $orderId; ?></h2>
            <p>Dear <?php echo $row['customer_name']; ?>,</p>
            <p>We are excited to inform you that your order has been shipped! Here are the details of your order:</p>
            <h3>Order Details:</h3>
