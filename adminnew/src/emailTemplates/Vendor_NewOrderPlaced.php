...
<head>
    ...
    <title>New Order Placed - <?php echo $order_id; ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>New Order Placed - <?php echo $order_id; ?></h2>
            <p>Dear Vendor,</p>
            ...
            <table class="order-details">
                ...
                <?php
                    $x=1;                    
                    $sql = "SELECT `product_title`,`product_qty`,`product_price`,`invoice_number`,`payment_type`,`shipping_charges`,`cod_charges`,`amount`,`coupon_code`,`customer_address` FROM `order_details` WHERE order_id='$order_id' AND invoice_number='$invoice_number' AND product_id IN (" . implode(',', $productIdsArray) . ")";
