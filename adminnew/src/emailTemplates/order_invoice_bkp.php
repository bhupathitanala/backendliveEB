...
<body>
    <div class="container">
        ...
        <div class="content">
            <p style="text-align:right">Invoice Number <?php echo $data['invoice_number']; ?></p>
            <p>Dear <?php echo $data['customer_name']; ?>,</p>
            ...
            <table class="order-details">
                ...
                <?php
                    ...
                    $sql = "SELECT `product_title`,`product_qty`,`product_price`,`order_id`,`payment_type`,`shipping_charges`,`cod_charges`,`amount` FROM `order_details` WHERE invoice_number='$invoice_number'";
                    //echo $sql;
